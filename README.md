...
### 5. 교내 내비게이션
고교학점제로 매시간 바쁘게 이동해야 하는 강의실, 최단거리로 빠르게 이동하세요. 시간표만 등록하면 다음 강의실이 어디인지 안내해드리겠습니다! 학교에 설치된 비콘을 이용해 내 위치를 기준으로 경로를 탐색합니다. 강의실의 위치를 잘 몰라도 해멜 필요가 없습니다! 자세한 이동 경로가 마치 실제 내비게이션처럼 표시되니까요.

...
class MinewBeaconData {
  ...
  Object encode() {
    ...
    pigeonMap['temperature'] = temperature;
    pigeonMap['humidity'] = humidity;
    pigeonMap['txPower'] = txPower;
    pigeonMap['inRange'] = inRange;
    return pigeonMap;
  }

  static MinewBeaconData decode(Object message) {
    ...
    return MinewBeaconData()
      ...
      ..temperature = pigeonMap['temperature'] as double?
      ..humidity = pigeonMap['humidity'] as double?
      ..txPower = pigeonMap['txPower'] as int?
      ..inRange = pigeonMap['inRange'] as bool?;
  }
}
    ...
    } else 
{
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 128:       
        return MinewBeaconData.decode(readValue(buffer)!);
...
class Api {
  ...
  Future<List<MinewBeaconData?>> getScannedBeacons() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.Api.getScannedBeacons', codec, binaryMessenger: _binaryMessenger);
    ...
    if (replyMap == null) {
      ...
      return (replyMap['result'] as List<Object?>?)!.cast<MinewBeaconData?>();
    }
  }

  Future<List<Map?>> getScannedBeaconsAsMap() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.Api.getScannedBeaconsAsMap', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(null) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
      ...
      return (replyMap['result'] as List<Object?>?)!.cast<Map?>();
    }
  }
